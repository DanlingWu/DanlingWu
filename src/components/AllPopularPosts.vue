        ...
        <div class="container">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="contents order-md-1 pl-0">
                        <h2><a href="blog-single.html">{{ posts.title }}</a></h2>
                        <p class="mb-3">{{ posts.body }}</p>
                        <div class="post-meta">
                        <span class="d-block"><a href="#">Dave Rogers</a> in <a href="#">{{ posts.category }}</a></span>
...
export default {
  ...
  computed: mapState({
    posts: state => state.popularPosts
  }),
  beforeMount() {
