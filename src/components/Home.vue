      ...
      <div class="py-0">
        <div class="container">
          <div class="half-post-entry d-block d-lg-flex bg-light" v-if="recentPosts.length > 0">
            <div class="img-bg" :style="{'background-image': 'url(' + 'http://127.0.0.1:5000/images/header_image_'+ recentPosts[0].id + '.jpg' + ')'}"></div>
            <div class="contents">
            ...
            <div class="row">
              <div class="col-md-6" v-if="recentPosts.length > 0">
                <div class="post-entry-1">
                  <a :href="'/Posts/' + recentPosts[0].id">
                    <img :src="'http://127.0.0.1:5000/images/header_image_'+ recentPosts[0].id + '.jpg'" alt="Image" class="img-fluid" />
                  </a>
                  <h2>
                    <a :href="'/Posts/' + recentPosts[0].id" >{{ recentPosts[0].title }}</a>
                  </h2>
              ...
              <div class="col-md-6">
                <div
                  ...
                  :post="post"
                >
                  <div class="thumbnail" :style="{'background-image': 'url(' + 'http://127.0.0.1:5000/images/header_image_'+ post.id + '.jpg' + ')'}"></div>
                  <div class="contents">
                    <h2>
